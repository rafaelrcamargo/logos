...
export default () => (
  <div className="center max-h-screen w-full flex-col overflow-hidden lg:flex-row">
    <div className="w-full px-12 py-12 lg:w-2/5 lg:px-24">
      <h1 className="text-6xl">Welcome!</h1>
      <p className="text-2xl">Please sign in with one of our providers:</p>
      <div className="flex flex-col gap-4 pt-8">
        {Object.entries(providers).map(([provider, [Icon, color]]) => (
          <Link
            ...
            className={cn(
              "center gap-4 rounded-lg border border-zinc-300 py-3 capitalize shadow-md shadow-zinc-300/30 duration-150 hover:scale-105 hover:shadow-2xl dark:border-zinc-600/30 dark:shadow-zinc-900",
              color
            )}
          >
    ...
    <div className="relative -mb-[40%] h-screen w-screen overflow-hidden rounded-[2rem] object-none shadow-2xl shadow-zinc-300/50 dark:shadow-zinc-900 lg:mb-0 lg:-mr-[20%] lg:w-4/5">
      <Image
        fill
        src="/auth.webp"
